...
def init_session_state():
    """Initialize session state varaibles"""
...
@st.cache_resource
def initialize_rag():
    """Initialize the RAG system (cachefd)"""
    try:
...
def main():
    ...
    st.markdown("As question about the loaded documents")
    ...
    if submit and question:
        if st.session_state.rag_system:
            with st.spinner("Searching..."):
                ...
                st.caption(f'Respond time : {elapsed_time:.2f} seconds')
